...
<table>
    <tbody>
        <tr id="unlimited-level">
            <td>
                <div class="col-md-6">
                    <h3 <span style="color: #ff5510">Create beautiful menu layouts <span>  </h3>
                ...
                <td width="50%">
                    <div class="col-md-6">
                        <p>
                            <img src="https://www.magezon.com/pub/media/ninjamenus2/create-beautiful-menu-layouts.png" alt="Create beautiful menu layouts" title="Create beautiful menu layouts" target="_self">          </p>
                        </div>
                    </td>
                </tr>
                <tr id="responsive">
                    <td>
                        <div class="col-md-6">
                         <img src="https://www.magezon.com/pub/media/ninjamenus2/fully-responsive-mobile-friendly.png" alt="Vertical Tabs on the Left" title="Fully Responsive - Mobile Friendly" target="_self"> </div>
                     </td>
                     <td width="50%">
                        <div class="col-md-6">
                ...
                <tr id="display-menu-in-4-types">
                 <td>
                    <div class="col-md-6">
                        <h3 <span style="color: #ff5510"> Display menu in 4 types<span>  </h3>
             ...
             <tr id="8-predefined-menus">
                ...
                <td width="50%">
                    <div class="col-md-6">
                        <h3 <span style="color: #ff5510"> 8 Predefined Menus <span>  </h3>
                            <div>
                ...
                <tr id="drag-drop-menu-builder">
                 <td>
                    <div class="col-md-6">
                        <h3 <span style="color: #ff5510"> Drag & Drop Menu Builder </span>  </h3>
        ...
        <tr id="11-elements-supported">
          ...
          <td width="50%">
            <div class="col-md-6">
                <h3> <span style="color: #ff5510">11 elements supported</span>  </h3>
                <div class="mgz-element-inner mgz-element-text-inner ">
    ...
    <tr id="easily-add-images">
      <td width="50%">
        <div class="col-md-6">
            <h3> <span style="color: #ff5510">Easily Add Images</span>  </h3>
            <div class="mgz-element-inner mgz-element-text-inner ">
...
<tr id="">
  ...
  <td width="50%">
    <div class="col-md-6">
        <h3> <span style="color: #ff5510">Tabbed Submenus</span>  </h3>
        <div class="mgz-element-inner mgz-element-text-inner ">
...
<tr id="menu-item">
  <td width="50%">
    <div class="col-md-6">
        <h3> <span style="color: #ff5510">Menu Item</span>  </h3>
        <div class="mgz-element-inner mgz-element-text-inner ">
...
<tr id="fastest-load-time-cache-supported">
  ...
  <td width="50%">
    <div class="col-md-6">
        <h3> <span style="color: #ff5510">Fastest load time, Cache Supported</span>  </h3>
        <div class="mgz-element-inner mgz-element-text-inner ">
...
<tr id="lazyload">
  <td width="50%">
    <div class="col-md-6">
        <h3> <span style="color: #ff5510">Lazy Load technique</span>  </h3>
        <div class="mgz-element-inner mgz-element-text-inner ">
...
<tr id="seo-friendly">
  ...
  <td width="50%">
    <div class="col-md-6">
        <h3> <span style="color: #ff5510">SEO Friendly</span>  </h3>
        <div class="mgz-element-inner mgz-element-text-inner ">
...
<tr id="multiple-stores">
  ...
  <td width="50%">
    <div class="col-md-6">
        <h3> <span style="color: #ff5510">Support Multiple Stores and Languages</span>  </h3>
        <div class="mgz-element-inner mgz-element-text-inner ">
...
<tr id="compatible-with-porto-ultimo">
    <td colspan="2">
            ...
            <td colspan="2">
                <h3>
                    ...
                    <table>
                        ...
                        <tr id="">
                            <td colspan="2">
                                <h3>Success Stories Using Our Ninja Menus</h3>
                                    <table>
                                        <tbody>
                                            <tr>
     ...
     <div>
      ...
      <p>
      With the help of Ninja Menus, adding image background for the submenu is now a piece of cake. Just by following some easy steps. Take a look at our User guide to get <a href="https://magezon.com/pub/media/productfile/ninjamenus-v2.0.0-user_guides.pdf">more details</a>.</p>
  </div>
  <div>
    <h3><b>
  ...
  <p>
  Just by choosing any language in “All store view" drop-down list. More details <a href="https://magezon.com/pub/media/productfile/ninjamenus-v2.0.0-user_guides.pdf">here</a>.</p>
</div>
  <div>
    <h3><b>
  ...
  <p>
 We supported all the languages listed in the drop-down list of All store view.</p>
</div>
  <div>
    <h3><b>
  ...
  <p>
 We've already added this function in our extension. Make your menu stick to the top by switching only 1 button in the backend. (We described in the <a href="https://magezon.com/pub/media/productfile/ninjamenus-v2.0.0-user_guides.pdf">user guide</a>).</p>
</div>
<br/><br/>
<h2>Support FAQs</h2>
<div>
